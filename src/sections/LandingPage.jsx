                ...
                <div className="container h-[91dvh] mx-auto flex px-5 py-5 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        ...
                        <div className="flex justify-center">
                            ...
                            <a href="https://drive.google.com/file/d/1VksksZIUbVFiCb3wdGfflrRXUcf9HYv8/view?usp=drive_link" target='_blank'><button className="ml-4 flex items-center gap-2 border-0 py-2 px-6 focus:outline-none rounded text-lg bg-btn_bg_color hover:bg-btn_hover_bg_color text-btn_text"><FiDownloadCloud fontSize={23} />Resume</button></a>
                        </div>
                    </div>
